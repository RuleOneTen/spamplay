...
class Movie(object):
    def __init__(self, title, year, imdb_rating, imdb_vote_count, cornell_id, genres=None):
        self.title = title
        self.year = year
...
class Character(object):
    def __init__(self, name, movie, cornell_id, gender=None, credit_position=None):
        self.name = name
        self.gender = gender
        self.movie = movie
...
class Corpus(object): 
    def __init__(self, zipfile_path):
        ...
        self.characters = {}
        self.lines = {}
        self.conversations = ()  # NOTE: this is a list, not a dict like the others
        ...
        for line in chars:
            ...
            self.characters[cid] = Character(cname, self.movies[mid], cid, gender=gender, credit_position=credpos)

        for line in lines: 
            lid, cid, mid, cname, text = line.split(separator)
            self.lines[lid] = DialogLine(self.characters[cid], self.movies[mid], text, lid)
        ...
        for line in convos: 
            ...
            self.conversations += (Conversation(characters, self.movies[mid], lines), )
